...
public class TestRest2SoapTransformer {
    ...
    public void testECommercePostRequest() throws Exception {
        ...
        Assertions.assertEquals("<?xml version=\"1.0\" encoding=\"UTF-8\"?><SOAP-ENV:Envelope xmlns:SOAP-ENV=\"http://schemas.xmlsoap.org/soap/envelope/\"><SOAP-ENV:Body><ns0:Order xmlns:ns0=\"http://example.com/ecommerce/schema\"><OrderId>24252542</OrderId><CustomerName>Joe</CustomerName><Products><ns0:Product><ns0:ProductId>prod-001</ns0:ProductId><ProductName>Red Apple</ProductName><Price>1.23</Price></ns0:Product><ns0:Product><ns0:ProductId>prod-002</ns0:ProductId><ProductName>Green Apple</ProductName><Price>1.52</Price></ns0:Product></Products></ns0:Order></SOAP-ENV:Body></SOAP-ENV:Envelope>", soapRequest.contents());
    }
